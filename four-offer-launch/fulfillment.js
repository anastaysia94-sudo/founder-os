...
function configured() {
  return Boolean(process.env.SUPABASE_SECRET_KEY && process.env.DELIVERY_TOKEN_SECRET);
}
...
module.exports = { configured, getPayment, recordCreated, completePayment, DELIVERY_URL };
